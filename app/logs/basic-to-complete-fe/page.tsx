...
export const metadata = {
  ...
  description: '기초부터 완성까지 프런트엔드 시리즈 목록',
  alternates: {
    canonical: '/logs/basic-to-complete-fe',
  },
}

export default async function SeriesPage() {
  const posts = await getLogPosts('basic-to-complete-fe')
  ...
  return (
    <main className="mt-24 pb-20">
      ...
      <h1 className="text-xl font-semibold">기초부터 완성까지 프런트엔드</h1>
